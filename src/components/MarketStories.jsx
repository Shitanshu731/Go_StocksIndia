...
const marketStories = ({isSidebar}) => {
  return (
      ...
      <h2 className='text-red-400 text-2xl mb-10 font-bold bg-slate-300 mx-auto w-[40%] max-md:w-[60%] p-1 items-center text-center md:text-left shadow-lg'>MARKET STORIES</h2>
